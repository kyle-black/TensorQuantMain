...
'''
def purged_walk_forward_split_with_embargo(data, initial_train_size=1, test_size=15000, gap=5, embargo_size=3):
    """
...
def run_split_process(data):
    ...
    for train, test in purged_walk_forward_split_with_embargo(data, initial_train_size=1, test_size=15000, gap=5, embargo_size=3):
