...
if __name__ in "__main__":
    #Load TF model
    model = tf.keras.models.load_model('models/EURUSD/EURUSD_0816_20.h5')

    # Load scaler
    scaler = joblib.load('models/EURUSD/EURUSD_0816_20_scaler.pkl')

    # Load PCA
    pca = joblib.load('models/EURUSD/EURUSD_0816_20_pca.pkl')
    #pca =None
    #scaler =None
    #model =None
