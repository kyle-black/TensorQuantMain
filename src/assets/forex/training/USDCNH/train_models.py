...
# Now you can fit the scaler
   ...
   # max_proba_indices= np.where(max_proba_indices==1,2,max_proba_indices)
    ...
    joblib.dump(clf, '../../predictions/models/USDCNH_models/random_forest_model_up_USDCNH_60.pkl')
    joblib.dump(pca, '../../predictions/models/USDCNH_models/pca_transformation_up_USDCNH_60.pkl')
    joblib.dump(scaler, '../../predictions/models/USDCNH_models/scaler_USDCNH.pkl')
