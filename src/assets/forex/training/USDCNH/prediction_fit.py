...
def make_predictions(symbol, new_data: pd.DataFrame) -> pd.Series:
    ...
    #clf = joblib.load(f'models/random_forest_model_up_USDCNH_60.pkl')
    #pca = joblib.load(f'models/pca_transformation_up_USDCNH_60.pkl')
    #scaler = joblib.load(f'models/scaler_USDCNH.pkl')
